...
constant integer UnitDelayedStandingKey=10
...
constant integer StormSpirit___HaveOverload=11
constant integer StormSpirit___OverloadEffectRight=12
constant integer StormSpirit___OverloadEffectLeft=13
	//ui的frame
integer GameUI
	//控制台UI
integer ConsoleUI
...
function CreateBuildingsForPlayer6 takes nothing returns nothing
    ...
    local trigger t
    local real life
    set u=CreateUnit(p, 'n001', - 22752.0, - 25376.0, 270.000)
    set u=CreateUnit(p, 'n002', - 23200.0, - 26464.0, 270.000)
endfunction
//===========================================================================
function CreateUnitsForPlayer6 takes nothing returns nothing
    ...
    local trigger t
    local real life
    set u=CreateUnit(p, 'HI01', - 24883.1, - 25545.9, 71.690)
    set u=CreateUnit(p, 'nhew', - 24257.4, - 25483.0, 187.098)
    set u=CreateUnit(p, 'nhew', - 24657.4, - 24883.8, 259.444)
    set u=CreateUnit(p, 'nm02', - 22806.3, - 25823.4, 172.900)
    set u=CreateUnit(p, 'nm03', - 22367.3, - 26026.4, 146.470)
    set u=CreateUnit(p, 'nm04', - 22639.1, - 26267.9, 107.840)
    set u=CreateUnit(p, 'nm05', - 22896.0, - 26254.9, 87.260)
    set u=CreateUnit(p, 'nm07', - 22417.5, - 25254.0, 252.450)
    call SetUnitState(u, UNIT_STATE_MANA, 0)
    set u=CreateUnit(p, 'nm06', - 22269.5, - 25685.2, 211.920)
endfunction
//===========================================================================
...
function CreateRegions takes nothing returns nothing
    ...
    set gg_rct_1_0_Movie_Init=Rect(- 22816.0, - 25440.0, - 22624.0, - 25312.0)
...
function CreateCameras takes nothing returns nothing
    ...
    call CameraSetupSetDestPosition(gg_cam_Camera_002, - 24429.6, - 25182.8, 0.0)
endfunction
//***************************************************************************
//*
//*  Custom Script Code
...
//TESH.scrollpos=0
//TESH.alwaysfold=0
// BEGIN IMPORT OF C:\Users\mayn\Desktop\GayIsland\map\main.j
...
// scope ItemSystem begins
    ...
    function ItemSystem__create_powerupitem_actions takes nothing returns boolean
        local trigger t= GetTriggeringTrigger()
        local integer h= GetHandleId(t)
    ...
    function ItemSystem__UnitPickPowerUpItem takes unit u,item it,integer itemId returns nothing
        ...
        if not UnitAddItem(u, newItem) then //如果给不了则创建PowerUp回去
            ...
            set h=CreateTimerEventTrigger(0., false, function ItemSystem__create_powerupitem_actions)
    ...
    function ItemSystem__unitdropitem_actions takes nothing returns boolean
        local trigger t= GetTriggeringTrigger()
        local integer h= GetHandleId(t)
    ...
    function ItemSystem__UnitDropRealItem takes unit u,item it,integer itemId returns nothing
        ...
        call TriggerAddCondition(t, Condition(function ItemSystem__unitdropitem_actions))
        call TriggerRegisterTimerEvent(t, 0., false)
        set t=null
    endfunction
    
    function ItemSystem__itemtrigger_actions takes nothing returns boolean
        ...
        if IsItemPowerup(it) then
            if hTriggerEventId == EVENT_PLAYER_UNIT_PICKUP_ITEM then
                call ItemSystem__UnitPickPowerUpItem(u , it , itemId)
            endif
        else
            ...
            if IsUnitType(u, UNIT_TYPE_HERO) then
                ...
                elseif hTriggerEventId == EVENT_PLAYER_UNIT_DROP_ITEM then //丢弃物品
                    ...
                    call ItemSystem__UnitDropRealItem(u , it , itemId) //需要在这之前判断是给别人了还是丢地上了
    ...
    function InitItemSystem takes nothing returns nothing
        ...
        call TriggerAddCondition(ItemAttrTrig, Condition(function ItemSystem__itemtrigger_actions))
...
function DragonSlave_Filter takes nothing returns boolean
	if Enemy_Alive_NoStructure_NoImmune(GetFilterUnit()) then
		call DestroyEffect(AddSpecialEffectTarget("Abilities\\Spells\\Human\\LagunaBlade\\LagunaBlade_hit.mdx", GetFilterUnit(), "origin"))
		return true
	endif
	return false
endfunction
...
// END IMPORT OF C:\Users\mayn\Desktop\GayIsland\map\main.j
//***************************************************************************
//*
//*  Players
//*
