function Trig_StarUnitActions takes nothing returns nothing
	...
	local unit u
	//屠夫
	set udg_Boos[0] = CreateUnit(Player(10), 'Dabo', -13120.00, -26820.00, 180.00)
	...
	//死灵法师
	set udg_Boos[2] = CreateUnit(Player(10), 'Dnec', -7600.00, -18464.00, 200.00)
	call ADDXP(udg_Boos[2],11900) //15级
	//call UnitAddAbility(udg_Boos[2],'ANeh') //竭心光环
	//中立
	call CreateUnit(Player(PLAYER_NEUTRAL_PASSIVE), 'nfoh', -12544.00, -12416.00, 340)
	// Ghoul
	...
	// Ghoul
	//usc2
	call CreateUnit(Player(10), 'ucs2', -24160.00, -26944.00, GetRandomDirectionDeg())
	call CreateUnit(Player(10), 'ucs2', -24320.00, -27008.00, GetRandomDirectionDeg())
	call CreateUnit(Player(10), 'ucs2', -24064.00, -27136.00, GetRandomDirectionDeg())
	// 屠夫前
	call CreateUnit(Player(10), 'uskm', -21312.00, -22720.00, GetRandomDirectionDeg())
	call CreateUnit(Player(10), 'uskm', -22272.00, -25920.00, GetRandomDirectionDeg())
	call CreateUnit(Player(10), 'uskw', -18336.00, -27136.00, GetRandomDirectionDeg())
	call CreateUnit(Player(10), 'uskw', -18240.00, -27392.00, GetRandomDirectionDeg())
	call CreateUnit(Player(10), 'ugho', -16960.00, -26880.00, GetRandomDirectionDeg())
	call CreateUnit(Player(10), 'uskm', -17152.00, -27104.00, GetRandomDirectionDeg())
	...
	// Skeleton
	call CreateUnit(Player(10), 'uskm', -13280.00, -23648.00, GetRandomDirectionDeg())
	call CreateUnit(Player(10), 'uskm', -13440.00, -23040.00, GetRandomDirectionDeg())
	call CreateUnit(Player(10), 'uskm', -13696.00, -23104.00, GetRandomDirectionDeg())
	call CreateUnit(Player(10), 'uskm', -13120.00, -23392.00, GetRandomDirectionDeg())
	...
	//地穴甲虫 /钻地
	set u = CreateUnit(Player(10), 'ucsB', -16800.00, -18464.00, GetRandomDirectionDeg())
	call PauseUnit( u , true)
	set u = CreateUnit(Player(10), 'ucsB', -17440.00, -18720.00, GetRandomDirectionDeg())
	call PauseUnit( u , true)
	set u = CreateUnit(Player(10), 'ucsB', -16928.00, -17728.00, GetRandomDirectionDeg())
	call PauseUnit( u , true)
	set u = CreateUnit(Player(10), 'ucsB', -16928.00, -17728.00, GetRandomDirectionDeg())
	call PauseUnit( u , true)
	set u = CreateUnit(Player(10), 'ucsB', -17312.00, -17408.00, GetRandomDirectionDeg())
	call PauseUnit( u , true)
	set u = CreateUnit(Player(10), 'ucsB', -17184.00, -16800.00, GetRandomDirectionDeg())
    call PauseUnit( u , true)
	set u = CreateUnit(Player(10), 'ucsB', -17152.00, -16032.00, GetRandomDirectionDeg())
	call PauseUnit( u , true)
	set u = CreateUnit(Player(10), 'ucsB', -16928.00, -15936.00, GetRandomDirectionDeg())
	call PauseUnit( u , true)
	// End
	call DestroyTrigger(GetTriggeringTrigger())
	
	//神秘通道
	set Elevator[0] = CreateUnit(Player(PLAYER_NEUTRAL_PASSIVE), 'hbla', -21150.00, -18656.00, 185.00)
	call SetUnitState(Elevator[0], UNIT_STATE_LIFE, 100)
	set g = null
	set u = null
endfunction
